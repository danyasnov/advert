...
const FilterForm: FC<{setShowFilter: (val: boolean) => void}> = observer(
  ({setShowFilter}) => {
          ...
          <Form className='space-y-8 divide-y w-full'>
            ...
            <div className='pt-4 flex justify-center s:justify-between'>
              <SecondaryButton
                ...
                className='w-full hidden s:block s:w-min py-3 px-3.5'>
                {t('RESET_FILTER')}
              </SecondaryButton>
              <PrimaryButton
                onClick={() => setShowFilter(false)}
                className='w-full s:w-min py-3 px-3.5 whitespace-nowrap'>
