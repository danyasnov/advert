    ...
    <div className='w-full mb-2 s:mb-0'>
      {note ? (
        <div className='flex w-full items-center '>
          <span className='text-greyscale-900 w-full text-body-16 rounded-lg bg-brand-a2 py-2.5 px-4 whitespace-nowrap s:max-w-sm m:max-w-xs l:max-w-md truncate block'>
            {note?.note}
          </span>
