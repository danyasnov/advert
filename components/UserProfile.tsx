...
const UserProfile: FC<Props> = observer(({onSelect = noop}) => {
  ...
  return (
    <div className='flex flex-col'>
      <h1 className='text-body-14 text-black-b font-bold mb-4 break-words'>
        {user.name}
      </h1>
      ...
      <div className=''>
        <div className='flex divide-x divide-shadow-b justify-between mt-3 mb-4'>
          <div className='flex flex-col w-1/2 items-center'>
            <span className='text-h-6 text-black-b font-bold'>
              {user.subscribers}
            </span>
            <span className='text-body-14 text-black-b'>
              {t('SUBSCRIBERS')}
            </span>
          </div>
          <div className='flex flex-col w-1/2 items-center'>
