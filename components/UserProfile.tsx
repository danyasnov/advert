...
const UserProfile: FC = observer(() => {
  ...
  return (
    <div className='flex flex-col items-center rounded-2xl bg-white py-5 px-7'>
      ...
      <span className='mb-3 text-body-14 text-green text-center font-semibold'>
        {t('ONLINE')}
      </span>
      ...
      <div className='flex justify-between mb-8 w-full'>
        <div className='flex flex-wrap w-1/2 justify-center'>
          <span className='text-body-14 text-greyscale-900 font-semibold mr-2'>
            {user.subscribers}
          </span>
        ...
        <div className='flex flex-wrap w-1/2 justify-center whitespace-pre'>
          <span className='text-body-14 text-greyscale-900 font-semibold mr-2'>
            {user.subscribs}
          </span>
          <span className='text-body-14 text-greyscale-900 font-normal'>
